<table>
  <tr>
    <td width="66%" valign="top">
      ...
      <p>
        로컬 AI, 게임 시스템, 아카이브 웹, 작은 로직 실험을 한곳에 모아두는 공개 작업실입니다.
      </p>
      <pre>
+--------------------------------------------------------------+
| BOOT TARGET : kenitoa                                        |
| MODE        : local-first tools / game lab / archive web     |
| PUBLIC MAP  : 6 work repositories + 1 profile repository     |
+--------------------------------------------------------------+
...
+--------------------------------------------------------------+
    ...
    <td width="34%" valign="top">
      ...
      <p><a href="#02-lab-shelf">02 Lab Shelf</a></p>
      <p><a href="#03-signal-map">03 Signal Map</a></p>
      <p><a href="https://github.com/kenitoa?tab=repositories">All Public Repositories</a></p>
      <hr>
      <h3>Current Public Scope</h3>
      <p><strong>7</strong> public repositories</p>
      <p><strong>6</strong> public work repositories highlighted here</p>
    </td>
  </tr>
</table>
