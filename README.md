...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0F172A,45:2563EB,100:14B8A6&height=230&section=header&text=kenitoa&fontSize=58&fontColor=ffffff&fontAlignY=37&desc=Public%20Repository%20Portfolio%20%7C%20AI%20%2F%20Archive%20%2F%20Game%20%2F%20Logic&descSize=16&descAlignY=58" />
...
| Category | Links |
|---|---|
| Profile | [GitHub Profile](https://github.com/kenitoa) · [Profile README Repo](https://github.com/kenitoa/kenitoa) · [All Public Repositories](https://github.com/kenitoa?tab=repositories) |
...
| kenitoa | 처음 방문한 사람이 공개 프로젝트를 바로 훑어볼 수 있도록 프로필 README를 포트폴리오 첫 화면으로 정리했습니다. | [Repo](https://github.com/kenitoa/kenitoa) |
...
| [kenitoa](https://github.com/kenitoa/kenitoa) | Profile README | Markdown | 공개 저장소 포트폴리오를 보여주는 GitHub 첫 화면 |
...
<img src="https://img.shields.io/badge/Public-22C55E?style=flat-square" />
</p>
...
## Public Repository Language Share

GitHub 공개 저장소의 `languages` API 기준으로 집계했습니다.  
비공개 저장소와 로컬 작업물은 포함하지 않았습니다.

| Language | Share | Bytes |
|---|---:|---:|
| C | 43.41% | 2,764,305 |
| C# | 23.95% | 1,525,470 |
| JavaScript | 13.75% | 875,574 |
| CSS | 7.59% | 483,135 |
| HTML | 3.29% | 209,648 |
| PowerShell | 2.38% | 151,322 |
| TypeScript | 1.75% | 111,487 |
| ShaderLab | 1.52% | 96,874 |
| C++ | 0.73% | 46,519 |
| XML | 0.60% | 37,960 |
| Python | 0.45% | 28,354 |
| HLSL | 0.31% | 19,973 |
| Wolfram Language | 0.24% | 15,479 |
| Batchfile | 0.04% | 2,269 |
